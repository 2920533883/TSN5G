...
void Ipv4::encapsulate(Packet *transportPacket)
{
    ...
    // add destAddress
    MacAddress destAddress = arp->resolveL3Address(l3AddressReq->getDestAddress().toIpv4(), NULL);
    ipv4Header->addTag<MyTag>()->setDestAddress(destAddress);
