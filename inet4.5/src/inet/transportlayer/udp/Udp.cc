...
void Udp::processUDPPacket(Packet *udpPacket)
{
    ...
    if (udpHeader->getDestPort() == 12340) {
            udpPacket->setKind(UDP_I_DATA);
            udpPacket->removeTagIfPresent<PacketProtocolTag>();
            udpPacket->removeTagIfPresent<DispatchProtocolReq>();
